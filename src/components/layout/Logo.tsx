  ...
  return (
    <div className="flex items-center gap-2 group cursor-pointer select-none">
      ...
      <div className="flex flex-col -space-y-1">
        <span className="text-sm md:text-base font-black tracking-tighter text-[var(--text)] uppercase leading-none">Homies</span>
        <span className="text-[9px] font-mono font-bold tracking-[0.3em] text-amber-500 uppercase leading-none italic">Studio</span>
      </div>
    </div>
  );
};
