...
const Logo: React.FC = () => {
  return (
    <div className="flex items-center gap-2 group cursor-pointer select-none">
      ...
      <div className="flex flex-col -space-y-1.5" style={{ fontFamily: 'var(--font-display)' }}>
        <span className="text-sm md:text-[18px] font-bold tracking-tighter text-[var(--text)] uppercase leading-none">H-𝕆𝕄-IES</span>
      </div>
    </div>
  );
};
